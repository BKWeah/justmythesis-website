...
export default function Home() {
  ...
  const pricing = {
    undergraduate: [
      { name: 'Proposal Development', price: 'USD $49' },
      { name: 'Foundation Thesis', price: 'USD $149' },
      { name: 'Complete Thesis Development', price: 'USD $299' },
      { name: 'Thesis Rescue', price: 'Quoted after assessment' },
      { name: 'Formatting & Compliance', price: 'USD $39' },
      { name: 'Defense Presentation', price: 'USD $57' }
    ],
    masters: [
      { name: 'Proposal Development', price: 'USD $97' },
      { name: 'Foundation Thesis', price: 'USD $247' },
      { name: 'Complete Thesis Development', price: 'USD $497' },
      { name: 'Thesis Rescue', price: 'Quoted after assessment' },
      { name: 'Formatting & Compliance', price: 'USD $77' },
      { name: 'Defense Presentation', price: 'USD $97' }
    ]
  };
  ...
  const SectionNav = ({ sectionIndex }: { sectionIndex: number }) => {
    ...
    return (
      <div className="flex items-center justify-between mt-12 pt-6 border-t border-[#C79A2D]/30">
        {!isFirst && prevSection && (
          <button
            onClick={() => scrollToSection(prevSection.id)}
            className="section-nav-btn section-nav-btn-light"
          >
        ...
        {nextSection && (
          <button
            ...
            className="section-nav-btn section-nav-btn-light ml-auto"
          >
  ...
  // CTA section navigation with WhatsApp button
  const CTASectionNav = ({ sectionIndex }: { sectionIndex: number }) => {
    const prevSection = sections[sectionIndex - 1];
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section id="additional" className="section min-h-screen flex flex-col relative overflow-hidden">
        ...
        <div className="container-custom flex-grow relative z-10">
          <div className="text-center mb-8">
            <h2 className="heading-lg text-white mb-4">Build the Skills to Move Forward</h2>
            <div className="divider-gold max-w-xs mx-auto" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-dark/70 text-sm mb-4">
                A group-based research coaching program designed to help students understand the research process, clarify project direction, improve topic focus, respond to supervisor feedback, and plan the next stages of their work with confidence.
              </p>
              <div className="mb-4">
                <h4 className="text-sm font-semibold text-brand-green mb-2">Deliverables:</h4>
                <ul className="text-dark/60 text-sm space-y-1">
                  <li>• Group research coaching session</li>
                  <li>• Research process guidance</li>
                  <li>• Topic and project direction support</li>
                  <li>• Supervisor feedback interpretation</li>
                  <li>• Practical next-step action plan</li>
                </ul>
              </div>
              <div className="flex items-center justify-between text-sm border-t border-gold/20 pt-4">
                <span className="text-dark/60">Duration: 5 hours</span>
                <span className="font-semibold text-gold">USD $57</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-dark/70 text-sm mb-4">
                A practical group training program that teaches students how to structure, organize, and write academic theses according to accepted academic standards.
              </p>
              <div className="mb-4">
                <h4 className="text-sm font-semibold text-brand-green mb-2">Deliverables:</h4>
                <ul className="text-dark/60 text-sm space-y-1">
      ...
      <section id="fees" className="section bg-cream min-h-screen flex flex-col">
        <div className="container-custom flex-grow">
          <div className="text-center mb-12">
            <h2 className="heading-lg text-brand-green mb-4">Clear Fees for the Support You Need</h2>
            <div className="divider-gold max-w-xs mx-auto" />
          </div>
      ...
      <section id="team" className="section bg-cream min-h-screen flex flex-col">
        <div className="container-custom flex-grow">
          <div className="text-center mb-12">
            <h2 className="heading-lg text-brand-green mb-4">Meet Our Academic Support Team</h2>
            <div className="divider-gold max-w-xs mx-auto" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {teamMembers.map((member, idx) => (
              <div key={idx} className="card p-6 text-center">
                <div className="w-[130px] h-[130px] rounded-full mx-auto mb-6 shadow-lg ring-4 ring-gold/30 overflow-hidden bg-brand-green">
                  <img 
                    src={member.image} 
                    alt={member.name}
                  ...
                  />
                  <div className="w-full h-full bg-gradient-to-br from-brand-green to-brand-green-light flex items-center justify-center hidden">
                    <span className="text-white font-bold text-4xl">{member.name.split(' ').map(n => n[0]).join('')}</span>
                  </div>
                </div>
      ...
      <section id="testimonials" className="section min-h-screen flex flex-col relative overflow-hidden">
        ...
        <div className="container-custom flex-grow relative z-10">
          <div className="text-center mb-12">
            <h2 className="heading-lg text-white mb-4">Student Feedback</h2>
            <div className="divider-gold max-w-xs mx-auto" />
          </div>
          <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
              ...
              <a
                ...
                className="btn bg-gold text-white hover:bg-gold/90 text-lg px-8 py-4"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
