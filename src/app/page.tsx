  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section id="additional" className="section bg-cream min-h-screen flex flex-col">
        <div className="container-custom flex-grow">
          <div className="text-center mb-12">
            <p className="eyebrow-label">Learning & Development</p>
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            {steps.map((step, idx) => (
              <div key={idx} className="card p-6 flex gap-5 items-start">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-gold to-gold-dark flex items-center justify-center text-white font-bold text-lg shadow-lg flex-shrink-0">
                  {idx + 1}
                </div>
      ...
      <section id="team" className="section bg-cream min-h-screen flex flex-col">
        <div className="container-custom flex-grow">
          <div className="text-center mb-12">
            <p className="eyebrow-label">Our Team</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {teamMembers.map((member, idx) => (
              <div key={idx} className="card p-8 text-center">
                <div className="w-[110px] h-[110px] sm:w-[130px] sm:h-[130px] lg:w-[160px] lg:h-[160px] rounded-full bg-gradient-to-br from-navy to-navy-light flex items-center justify-center mx-auto mb-6 shadow-lg ring-4 ring-gold/30">
                  <span className="text-gold font-bold text-3xl sm:text-4xl lg:text-5xl">{member.initials}</span>
                </div>
                <h3 className="font-bold text-navy text-xl mb-2">{member.name}</h3>
                <p className="text-gold text-sm font-semibold mb-3">{member.position}</p>
                <p className="text-navy/70 text-sm mb-4 leading-relaxed">{member.discipline}</p>
                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-gold/10 rounded-full">
                  ...
                  <span className="text-sm font-medium text-navy">Experience Since {member.experienceSince}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="notice" className="section bg-cream min-h-screen flex flex-col">
        <div className="container-custom flex-grow">
          <div className="text-center mb-12">
            <p className="eyebrow-label">Important Information</p>
            <h2 className="heading-lg text-navy mb-4">Notice to Students</h2>
            <div className="divider-gold max-w-xs mx-auto" />
          </div>
      ...
      <footer className="site-footer py-12">
        <div className="container-custom">
          <div className="flex flex-col items-center text-center">
            <div className="mb-6">
              <h3 className="font-bold text-2xl text-navy mb-2">JUSTmyTHESIS™</h3>
              <p className="text-navy/60">Focus on Your Research. We'll Handle the Thesis.</p>
            </div>
            <div className="flex flex-col sm:flex-row items-center gap-4 text-navy/60 mb-6">
              <a href="/terms" className="hover:text-gold transition-colors">Terms of Service</a>
              <span className="hidden sm:block text-gold">•</span>
              <a href="/privacy" className="hover:text-gold transition-colors">Privacy Policy</a>
            </div>
          </div>
          <div className="mt-8 pt-8 border-t border-navy/10 text-center text-navy/40 text-sm">
